...
Fifty-three records shaped this repo. Read them when you want to know *why* something
...
| [0048](0048-the-gallery-points-at-the-editor-rather-than-copying-it.md) | The gallery points at the editor rather than copying it | **proposed**, not accepted, because three of its four decisions are to stop; §3 built in #215, which is one sentence and one link on `/components`; strikes 0045 §10 whole and answers its four open questions by not building the surface that raised them, two open items named |
