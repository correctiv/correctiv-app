...
| [0036](0036-the-home-screen-becomes-data.md) | The home screen becomes data, and the app survives what it does not know | accepted, partly built in #177 — the document, its parser and its default layout; §15 in #246, the fetch in #245 and the configurator through 0045 to 0053; the workbench's scenarios in #NNN, the election night first, with sample data that holds the pins and not the feeds; sixteen decisions from a product interview, retires nothing, narrows #163 to its last question and leaves that one to the source decision; five of its own claims retired by 0039 and four of §2's by 0045 |
