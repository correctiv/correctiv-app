...
| [0049](0049-the-catalogue-is-a-package.md) | The catalogue is a package, and the locale comes from the host | accepted, **§1, §2, §5 and §6 built in #219**, §3 and §4 not; six decisions, takes the strings out of the app so the core's own German stops living in one of its hosts, names four things that deliberately do not move with them, retires two claims in 0026 §6 and one sentence of AGENTS.md, the one-language checks split between the package and the app |
