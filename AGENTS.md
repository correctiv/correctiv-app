...
It is not in the app at all, so there is now no place under `apps/mobile/src` where
a German character may be written ([ADR 0049](adr/0049-the-catalogue-is-a-package.md)).
