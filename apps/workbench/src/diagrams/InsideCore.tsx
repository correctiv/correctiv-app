 ...
 * and reads "60 TypeScript files" out of this file's text; it counts the members
...
export const INSIDE_CORE_COPY = defineMessages({
  ...
  lede: {
    id: 'insideCore.lede',
    defaultMessage:
      '60 TypeScript files in seven layers. Imports point down the stack, the contracts sit at the bottom, and below them is a line nothing in the package crosses.',
    description:
  ...
  files: {
    id: 'insideCore.files',
    defaultMessage: '60 TypeScript files',
    description:
  ...
  altLede: {
    ...
    defaultMessage:
      '<code>packages/app-core</code>, 60 TypeScript files. Imports point down the stack. Layers from the top:',
    description:
