 ...
 * drawing's own source rather than out of this file. So "61 TypeScript-Dateien"
...
export const insideCore: Record<string, string> = {
  ...
  'insideCore.lede':
    '61 TypeScript-Dateien in sieben Schichten. Importe zeigen den Stapel hinunter, die Verträge liegen unten, und darunter liegt eine Linie, die nichts im Paket überquert.',
  ...
  'insideCore.files': '61 TypeScript-Dateien',
  ...
  'insideCore.alt.lede':
    '<code>packages/app-core</code>, 61 TypeScript-Dateien. Importe zeigen den Stapel hinunter. Die Schichten von oben:',
